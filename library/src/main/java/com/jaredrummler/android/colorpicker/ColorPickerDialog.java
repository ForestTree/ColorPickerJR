...
public class ColorPickerDialog extends DialogFragment implements ColorPickerView.OnColorChangedListener, TextWatcher {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        AlertDialog.Builder builder = new MaterialAlertDialogBuilder(requireActivity()).setView(rootView)
    ...
    private void setupTransparency() {
        ...
        transparencySeekBar.setValueFrom(0);
        transparencySeekBar.setValueTo(255f);
        transparencySeekBar.setValue(progress);
        int percentage = (int) ((double) progress * 100 / 255);
        transparencyPercText.setText(String.format(Locale.ENGLISH, "%d%%", percentage));

        transparencySeekBar.addOnChangeListener((slider, value, fromUser) -> {
            int percentage1 = (int) ((double) value * 100 / 255);
            transparencyPercText.setText(String.format(Locale.ENGLISH, "%d%%", percentage1));
            int alpha = 255 - (int) value;
